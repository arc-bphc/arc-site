      ...
      >
        <div className="header m-0 flex w-1/2 flex-col items-center justify-center text-center">
          ...
          <div className="header-links">
            <a className="link p-2 text-xl" href="#about" data-scroll="">
              About Us
            </a>
            <a className="link p-2 text-xl" href="#team" data-scroll="">
              Our Team
            </a>
            <a className="link p-2 text-xl" href="#sponsors" data-scroll="">
              Sponsors
            </a>
            <a className="link p-2 text-xl" href="#contact" data-scroll="">
              Contact Us
            </a>
            <a className="header-vertical-line p-2 text-xl" data-scroll="">
              |
            </a>
            <a className="link p-2 text-xl" href="https://arc-bphc.github.io/site/resources/">
              Resources
            </a>
          </div>
        </div>
