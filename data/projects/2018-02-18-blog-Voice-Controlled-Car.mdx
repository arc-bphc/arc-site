...
full_width: false
header: true
cover: /static/assets/images/blog/thumbnails/Voice Controlled Car.png
---
...
In our world of embedded electronics hackery, Bluetooth serves as an excellent protocol for wirelessly transmitting relatively small amounts of data over a short range (Less than 100m). It’s perfectly suited as a wireless replacement for serial communication interfaces.
...
<Image
  src="/static/assets/images/blog/Voice-Controlled-Car/1.png"
  alt="Resistor"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/Voice-Controlled-Car/2.png"
  alt="Resistor"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/Voice-Controlled-Car/3.png"
  alt="Resistor"
  width="500"
  height="500"
/>
