...
full_width: false
header: true
cover: /static/assets/images/blog/thumbnails/Bot Control using RF.png
---
...
<Image src="/static/assets/images/blog/thumbnails/Bot Control using RF.png" alt="Resistor" width='500' height='500'>
