...
full_width: false
header: true
cover: /static/images/projects/thumbnails/WiFi Controlled Lock for Room.png
---
...
- 1-L298 Motor Driver
  <Image
    src="/static/images/projects/thumbnails/WiFi Controlled Lock for Room.png"
    alt="Resistor"
    width="500"
    height="500"
  />
...
<Image
  src="/static/images/projects/Wifi-controlled-lock/1.png"
  alt="Resistor"
  width="500"
  height="500"
/>
