...
full_width: false
header: true
cover: /static/images/projects/thumbnails/Bluetooth controlled Self-Balancing Segway Robot.png
---
...
- 1- 7.4V LiPo Battery.
  <Image
    src="/static/images/projects/bluetooth-self-balancing/2.png"
    alt="Resistor"
    width="500"
    height="500"
  />
...
<Image
  src="/static/images/projects/bluetooth-self-balancing/1.png"
  alt="Resistor"
  width="500"
  height="500"
/>
