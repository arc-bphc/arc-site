...
full_width: false
header: true
cover: /static/images/projects/thumbnails/ESP8266 based temperature logger.png
---
...
<ImageSwiper
  imageArray={[
    '/static/images/projects/ESP8266-temp-sensor/1.png',
    '/static/images/projects/ESP8266-temp-sensor/2.png',
    '/static/images/projects/thumbnails/ESP8266 based temperature logger.png',
  ]}
/>
