...
full_width: false
header: true
cover: /static/assets/images/blog/thumbnails/2D Mapping Bot.png
---
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/driver.png"
  alt="Driver"
  width="500"
  height="500"
/>
It is the motor driver generally used with steppers. Each 28BYJ-48 stepper needs one ULN2003 stepper
driver to run. - IN1,IN2,IN3,IN4 - Connected to the Arduino and receive signals from the microcontroller.
- 5-12V - Power supply to the driver. - 5 Pins in the White casing - Connected to the stepper motor.
**Datasheet of the Component:** https://components101.com/sites/default/files/component_datasheet/IC%20ULN2003%20Datasheet_0.pdf
### 28BYJ-48 Stepper Motor
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/stepper.png"
  alt="stepper"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/servo.png"
  alt="Servo"
  width="500"
  height="500"
/>
It is a micro servo motor which can rotate from 0 to 180 degrees. The pins description is as follows:
- Yellow - Connected to a digital OUTPUT pin. Servo is rotated by giving the angular position using digitalWrite
on this pin. - Red - Connected to +5V Power supply. - Brown - Connected to ground. **Here is the link
for the data sheet :** http://www.ee.ic.ac.uk/pcheung/teaching/DE1_EE/stores/sg90_datasheet.pdf

### HCSR04 Ultrasonic Sensor

<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/us.png"
  alt="Ultrasonic"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/bt.png"
  alt="Bluetooth"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/diagram.png"
  alt="Schematic"
  width="500"
  height="500"
/>
...
- line 50 to 57 : making the input values for both the motors as low so as to switch off the stepper motors, allowing further execution of _void loop()_.

_Coming out of the if-else condition :_
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/output1.png"
  alt="Output1"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/output2.png"
  alt="Output2"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/output3.png"
  alt="Output3"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/output4.png"
  alt="Output4"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/r1.png"
  alt="Robot1"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/r2.png"
  alt="Robot2"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/r3.png"
  alt="Robot3"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/r4.png"
  alt="Robot4"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/r5.png"
  alt="Robot5"
  width="500"
  height="500"
/>
...
<Image
  src="/static/assets/images/blog/2D-Mapping-Robot/r6.png"
  alt="Robot6"
  width="500"
  height="500"
/>
