...
A photo-resistor’s resistance value changes with respect to the intensity of light falling on it.
 ...
 <Image src="/static/assets/images/blog/Piano-Stairs/circuit.png" alt="Resistor" width='500' height='500'>
...
Also, make a array of 1 watt led to illuminate the LDR
 ...
 <Image src="/static/assets/images/blog/thumbnails/Piano Stairs.png" alt="Resistor" width='500' height='500'>
