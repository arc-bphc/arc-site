...
<div class="swiper swiper-demo">
  <div class="swiper__wrapper">
    <div class="swiper__slide">
      <Image class="image image" src="/assets/images/blog/ESP8266-temp-sensor/1.png" />
    </div>
    <div class="swiper__slide">
      <Image class="image image" src="/assets/images/blog/ESP8266-temp-sensor/2.png" />
    </div>
    <div class="swiper__slide">
      <Image
        class="image image"
        src="/assets/images/blog/thumbnails/ESP8266 based temperature logger.png"
      />
    </div>
  </div>
