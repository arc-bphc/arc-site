...
full_width: false
header: true
cover: /static/assets/images/blog/thumbnails/ESP8266 based temperature logger.png
---
...
<ImageSwiper
  imageArray={[
    '/static/assets/images/blog/ESP8266-temp-sensor/1.png',
    '/static/assets/images/blog/ESP8266-temp-sensor/2.png',
    '/static/assets/images/blog/thumbnails/ESP8266 based temperature logger.png',
  ]}
/>
