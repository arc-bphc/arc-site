...
<ImageSwiper
  imageArray={[
    '/assets/images/blog/ESP8266-temp-sensor/1.png',
    '/assets/images/blog/ESP8266-temp-sensor/2.png',
    '/assets/images/blog/thumbnails/ESP8266 based temperature logger.png',
  ]}
/>
