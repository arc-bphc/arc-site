...
1. apt-get signature issue

- You have to run a command to get the signaturs back up

2. catkin_make not found
...
and then run the script again 3. python being used instead of python3
